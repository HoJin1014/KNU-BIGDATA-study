...
price_meal = {'에스프레소': 3500, 'latte': 4000, 'smoothie': 4500, 'tea': 3000}
price_drink = {'김밥': 3500, '떡볶이': 4000, '라면': 4500, 'tea': 3000}
...
btn_meal_5 = tk.Button(frame2, text="쫄면\n(6000원)", padx="10", pady="10", width="10", command=lambda: meal_add('쫄면'))
