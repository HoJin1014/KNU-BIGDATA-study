...
# (3) 종료 입력 전까지 무한 반복
# --------------------------------------------------------------------
# 전역변수 및 상수 선언 -------------------------------------------------- # 상수 - 값을 바꾸지 못함.
DIR_PATH='./AddressBook/'       # 파일 저장 폴더
ADDR_LIST=['가_111', '가나다_111']   # 주소파일 저장 리스트
...
def initApp():
    pass
    #with open(DIR_PATH, mode='r', encoding='utf-8') as f:
    #    print(f.read())
...
# 테스트
#print( '가가가' in '가나다_111' )
#print( '가나다' in '가나다_111' )
#print( '010_222_333' in '010_222_333' )

#searchAddress('111')
#addAddress('마징가', '010-111', '대구', 'ma@naver.com')
#showAddress()